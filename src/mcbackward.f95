subroutine mcbackward(a,b,init,obs,m,p,n,miss,beta,r)
...
subroutine mvmcbackward(a,b,init,obs,m,p,n,miss,k,beta,r)
    ...
    do i = 1,k
        call mcbackward(a,b,init,obs(i,:,:),m,p,n,miss(i,:,:),beta(:,:,i),r)
    end do
