...
static constexpr std::array<const char*, 105> locations_array__ =
  ...
  " (in 'string', line 50, column 0 to column 14)",
  " (in 'string', line 53, column 0 to column 39)",
  " (in 'string', line 56, column 0 to column 22)",
  " (in 'string', line 59, column 2 to column 16)",
  " (in 'string', line 60, column 2 to column 20)",
  " (in 'string', line 62, column 0 to column 31)",
  " (in 'string', line 113, column 2 to column 22)",
  " (in 'string', line 114, column 2 to column 26)",
  " (in 'string', line 64, column 2 to column 64)",
  " (in 'string', line 63, column 14 to line 65, column 1)",
  " (in 'string', line 63, column 0 to line 65, column 1)",
  " (in 'string', line 68, column 0 to column 48)",
  " (in 'string', line 72, column 2 to column 57)",
  ...
  " (in 'string', line 84, column 4 to column 32)",
  " (in 'string', line 86, column 0 to column 17)",
  " (in 'string', line 89, column 2 to column 26)",
  " (in 'string', line 88, column 14 to line 90, column 1)",
  " (in 'string', line 88, column 0 to line 90, column 1)",
  " (in 'string', line 95, column 2 to column 54)",
  ...
  " (in 'string', line 92, column 20 to line 102, column 7)",
  " (in 'string', line 92, column 6 to line 102, column 7)",
  " (in 'string', line 103, column 6 to column 44)",
  " (in 'string', line 91, column 18 to line 104, column 5)",
  " (in 'string', line 91, column 4 to line 104, column 5)",
  ...
  " (in 'string', line 53, column 16 to column 21)",
  " (in 'string', line 53, column 23 to column 26)",
  " (in 'string', line 56, column 6 to column 7)",
  " (in 'string', line 56, column 17 to column 18)",
  " (in 'string', line 62, column 6 to column 7)",
  " (in 'string', line 62, column 16 to column 17)",
  " (in 'string', line 62, column 19 to column 22)",
...
public:
  ...
  model_nhmm_cvc(stan::io::var_context& context__, unsigned int
    ...
    num_params_r__ = (S - 1) + (S * beta_s_raw_2dim__ * K_s) + (S * (M - 1));
  }
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"Pi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(S) + "},\"block\":\"parameters\"},{\"name\":\"beta_s_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_s_raw_2dim__) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"parameters\"},{\"name\":\"B\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(M) + "}},\"block\":\"parameters\"},{\"name\":\"log_lik_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"prior_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"beta_s\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(S) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"prior\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"Pi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((S -1)) + "},\"block\":\"parameters\"},{\"name\":\"beta_s_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_s_raw_2dim__) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"parameters\"},{\"name\":\"B\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((M -1)) + "}},\"block\":\"parameters\"},{\"name\":\"log_lik_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"prior_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"beta_s\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(S) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"prior\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
