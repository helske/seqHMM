...
#include "stanExports_mnhmm_cvvv.h"

RCPP_MODULE(stan_fit4mnhmm_cvvv_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mnhmm_cvvv")
