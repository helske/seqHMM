...
namespace model_mnhmm_vcvv_namespace {
...
static constexpr std::array<const char*, 182> locations_array__ =
  ...
  " (in 'string', line 128, column 15 to column 16)",
  " (in 'string', line 128, column 18 to column 22)",
  ...
  " (in 'string', line 129, column 26 to line 135, column 9)",
  " (in 'string', line 129, column 8 to line 135, column 9)",
...
class model_mnhmm_vcvv final : public model_base_crtp<model_mnhmm_vcvv> {
private:
  int N;
  int max_T;
  std::vector<int> T;
...
public:
  ~model_mnhmm_vcvv() {}
  model_mnhmm_vcvv(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mnhmm_vcvv_namespace::model_mnhmm_vcvv";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mnhmm_vcvv_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mnhmm_vcvv_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_mnhmm_vcvv_namespace::model_mnhmm_vcvv;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mnhmm_vcvv_namespace::profiles__;
}
#endif
#endif
