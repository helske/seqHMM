...
#include "stanExports_multichannel_nhmm_vcc.h"

RCPP_MODULE(stan_fit4multichannel_nhmm_vcc_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_multichannel_nhmm_vcc")
