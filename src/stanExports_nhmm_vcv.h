...
namespace model_nhmm_vcv_namespace {
...
static constexpr std::array<const char*, 144> locations_array__ =
  ...
  " (in 'string', line 114, column 5 to column 43)",
...
class model_nhmm_vcv final : public model_base_crtp<model_nhmm_vcv> {
private:
  int N;
  int T;
  int M;
...
public:
  ~model_nhmm_vcv() {}
  model_nhmm_vcv(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_nhmm_vcv_namespace::model_nhmm_vcv";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_nhmm_vcv_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_nhmm_vcv_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_nhmm_vcv_namespace::model_nhmm_vcv;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_nhmm_vcv_namespace::profiles__;
}
#endif
#endif
