...
#include "stanExports_multichannel_mnhmm_cccc.h"

RCPP_MODULE(stan_fit4multichannel_mnhmm_cccc_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_multichannel_mnhmm_cccc")
