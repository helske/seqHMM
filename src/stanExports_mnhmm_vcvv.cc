...
#include "stanExports_mnhmm_vcvv.h"

RCPP_MODULE(stan_fit4mnhmm_vcvv_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mnhmm_vcvv")
