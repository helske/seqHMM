...
List gradientLogMC(NumericVector transitionMatrix, NumericVector emissionArray, NumericVector initialProbs,
IntegerVector obsArray,NumericVector rowSumsA,NumericMatrix rowSumsB, double sumInit,
IntegerVector transNZ, IntegerVector emissNZ, IntegerVector initNZ, NumericVector expPsi) { 
  ...
  internalForwardMCLog(transitionLog, emissionLog, initLog, obs, alpha);
  internalBackwardMCLog(transitionLog, emissionLog, obs, beta);     
