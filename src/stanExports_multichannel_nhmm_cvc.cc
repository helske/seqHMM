...
#include "stanExports_multichannel_nhmm_cvc.h"

RCPP_MODULE(stan_fit4multichannel_nhmm_cvc_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_multichannel_nhmm_cvc")
