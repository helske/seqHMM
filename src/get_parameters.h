...
arma::vec get_omega(
    const arma::mat& gamma_omega_raw, const arma::vec X, const bool logspace
);
arma::vec get_pi(
    const arma::mat& beta_raw, const arma::vec X, const bool logspace
);
arma::cube get_A(
    const arma::cube& beta_raw, const arma::mat& X, const bool logspace,
    const bool tv = true
);
arma::cube get_B(
    const arma::cube& beta_raw, const arma::mat& X, const bool logspace, 
