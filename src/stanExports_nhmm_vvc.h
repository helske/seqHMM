...
static constexpr std::array<const char*, 118> locations_array__ =
  ...
  " (in 'string', line 57, column 0 to column 39)",
  " (in 'string', line 60, column 0 to column 22)",
  ...
  " (in 'string', line 84, column 15 to line 86, column 1)",
  ...
  " (in 'string', line 92, column 10 to column 11)",
  " (in 'string', line 92, column 20 to column 21)",
  " (in 'string', line 92, column 23 to column 24)",
  " (in 'string', line 92, column 4 to column 32)",
  ...
  " (in 'string', line 100, column 0 to column 48)",
  ...
  " (in 'string', line 101, column 20 to line 111, column 7)",
  " (in 'string', line 101, column 6 to line 111, column 7)",
  " (in 'string', line 112, column 6 to column 44)",
  " (in 'string', line 98, column 18 to line 113, column 5)",
  " (in 'string', line 98, column 4 to line 113, column 5)",
  " (in 'string', line 114, column 4 to column 23)",
  " (in 'string', line 87, column 2 to line 115, column 3)",
  ...
  " (in 'string', line 57, column 16 to column 21)",
  " (in 'string', line 57, column 23 to column 26)",
  " (in 'string', line 60, column 6 to column 7)",
  " (in 'string', line 60, column 17 to column 18)",
...
public:
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha_i_raw\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(alpha_i_raw_1dim__) + "},\"block\":\"parameters\"},{\"name\":\"beta_i_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_i_raw_1dim__) + ",\"cols\":" + std::to_string(K_i) + "},\"block\":\"parameters\"},{\"name\":\"beta_s_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_s_raw_2dim__) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"parameters\"},{\"name\":\"B\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(M) + "}},\"block\":\"parameters\"},{\"name\":\"log_lik_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"prior_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alpha_i\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(S) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta_i\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(S) + ",\"cols\":" + std::to_string(K_i) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta_s\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(S) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"prior\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha_i_raw\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(alpha_i_raw_1dim__) + "},\"block\":\"parameters\"},{\"name\":\"beta_i_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_i_raw_1dim__) + ",\"cols\":" + std::to_string(K_i) + "},\"block\":\"parameters\"},{\"name\":\"beta_s_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_s_raw_2dim__) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"parameters\"},{\"name\":\"B\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((M -1)) + "}},\"block\":\"parameters\"},{\"name\":\"log_lik_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"prior_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alpha_i\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(S) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta_i\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(S) + ",\"cols\":" + std::to_string(K_i) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta_s\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(S) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"prior\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((alpha_i_raw_1dim__ + (beta_i_raw_1dim__ *
      K_i)) + ((S * beta_s_raw_2dim__) * K_s)) + (S * M));
