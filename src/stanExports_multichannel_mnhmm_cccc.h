...
namespace model_multichannel_mnhmm_cccc_namespace {
...
static constexpr std::array<const char*, 207> locations_array__ =
  ...
  " (in 'string', line 144, column 8 to column 32)",
  " (in 'string', line 145, column 8 to column 71)",
  " (in 'string', line 143, column 21 to line 146, column 7)",
  " (in 'string', line 143, column 6 to line 146, column 7)",
  " (in 'string', line 142, column 19 to line 147, column 5)",
  " (in 'string', line 142, column 4 to line 147, column 5)",
  ...
  " (in 'string', line 149, column 22 to line 154, column 9)",
  " (in 'string', line 149, column 8 to line 154, column 9)",
  " (in 'string', line 155, column 8 to column 49)",
  " (in 'string', line 148, column 20 to line 156, column 7)",
  " (in 'string', line 148, column 6 to line 156, column 7)",
...
class model_multichannel_mnhmm_cccc final : public model_base_crtp<model_multichannel_mnhmm_cccc> {
private:
  int N;
  int T;
  int max_M;
...
public:
  ~model_multichannel_mnhmm_cccc() {}
  model_multichannel_mnhmm_cccc(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_multichannel_mnhmm_cccc_namespace::model_multichannel_mnhmm_cccc";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  inline std::string model_name() const final {
    return "model_multichannel_mnhmm_cccc";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_multichannel_mnhmm_cccc_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
        ...
        for (int d = 1; d <= D; ++d) {
          ...
          for (int c = 1; c <= C; ++c) {
            ...
            for (int s = 1; s <= S; ++s) {
              ...
              stan::model::assign(log_B, zeros_M, "assigning variable log_B",
                stan::model::index_uni(c), stan::model::index_uni(s),
                stan::model::index_omni());
                ...
                stan::math::transpose(
                  stan::math::log_softmax(
                    stan::model::rvalue(beta_o, "beta_o",
                      stan::model::index_uni(d), stan::model::index_uni(c),
                      stan::model::index_uni(s),
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_multichannel_mnhmm_cccc_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_multichannel_mnhmm_cccc_namespace::model_multichannel_mnhmm_cccc;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_multichannel_mnhmm_cccc_namespace::profiles__;
}
#endif
#endif
