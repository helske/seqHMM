...
namespace model_mnhmm_vcvc_namespace {
...
static constexpr std::array<const char*, 179> locations_array__ =
  ...
  " (in 'string', line 124, column 6 to column 51)",
  " (in 'string', line 123, column 18 to line 125, column 5)",
  " (in 'string', line 123, column 4 to line 125, column 5)",
...
class model_mnhmm_vcvc final : public model_base_crtp<model_mnhmm_vcvc> {
private:
  int N;
  int T;
  int M;
...
public:
  ~model_mnhmm_vcvc() {}
  model_mnhmm_vcvc(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mnhmm_vcvc_namespace::model_mnhmm_vcvc";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mnhmm_vcvc_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mnhmm_vcvc_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_mnhmm_vcvc_namespace::model_mnhmm_vcvc;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mnhmm_vcvc_namespace::profiles__;
}
#endif
#endif
