...
namespace model_multichannel_mnhmm_vcvc_namespace {
...
static constexpr std::array<const char*, 209> locations_array__ =
  ...
  " (in 'string', line 159, column 4 to column 50)",
  " (in 'string', line 160, column 11 to column 12)",
  " (in 'string', line 160, column 4 to column 19)",
...
class model_multichannel_mnhmm_vcvc final : public model_base_crtp<model_multichannel_mnhmm_vcvc> {
private:
  int N;
  int T;
  int max_M;
...
public:
  ~model_multichannel_mnhmm_vcvc() {}
  model_multichannel_mnhmm_vcvc(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_multichannel_mnhmm_vcvc_namespace::model_multichannel_mnhmm_vcvc";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  inline std::string model_name() const final {
    return "model_multichannel_mnhmm_vcvc";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_multichannel_mnhmm_vcvc_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_multichannel_mnhmm_vcvc_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_multichannel_mnhmm_vcvc_namespace::model_multichannel_mnhmm_vcvc;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_multichannel_mnhmm_vcvc_namespace::profiles__;
}
#endif
#endif
