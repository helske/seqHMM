...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< NumericMatrix >::type X_(X_SEXP );
        Rcpp::traits::input_parameter< IntegerVector >::type numberOfStates(numberOfStatesSEXP );
        NumericVector __result = gradientx(transitionMatrix, emissionArray, initialProbs, obsArray, rowSumsA, rowSumsB, sumInit, transNZ, emissNZ, initNZ, expPsi, coefs, X_, numberOfStates);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< NumericMatrix >::type X_(X_SEXP );
        Rcpp::traits::input_parameter< IntegerVector >::type numberOfStates(numberOfStatesSEXP );
        List __result = viterbix(transitionMatrix, emissionArray, initialProbs, obsArray, coefs, X_, numberOfStates);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< NumericMatrix >::type X_(X_SEXP );
        Rcpp::traits::input_parameter< IntegerVector >::type numberOfStates(numberOfStatesSEXP );
        List __result = viterbiMCx(transitionMatrix, emissionArray, initialProbs, obsArray, coefs, X_, numberOfStates);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
