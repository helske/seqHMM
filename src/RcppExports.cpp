...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X_(X_SEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type numberOfStates(numberOfStatesSEXP);
    __result = Rcpp::wrap(viterbiMix(transitionMatrix, emissionArray, initialProbs, obsArray, coefs, X_, numberOfStates));
    return __result;
END_RCPP
}
// viterbiMixMC
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X_(X_SEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type numberOfStates(numberOfStatesSEXP);
    __result = Rcpp::wrap(viterbiMixMC(transitionMatrix, emissionArray, initialProbs, obsArray, coefs, X_, numberOfStates));
    return __result;
END_RCPP
}
