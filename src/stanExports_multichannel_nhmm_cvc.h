...
static constexpr std::array<const char*, 116> locations_array__ =
  ...
  " (in 'string', line 51, column 0 to column 14)",
  " (in 'string', line 54, column 0 to column 39)",
  " (in 'string', line 57, column 0 to column 25)",
  " (in 'string', line 60, column 2 to column 16)",
  " (in 'string', line 61, column 2 to column 20)",
  " (in 'string', line 63, column 0 to column 31)",
  ...
  " (in 'string', line 69, column 0 to column 48)",
  " (in 'string', line 73, column 2 to column 57)",
  ...
  " (in 'string', line 87, column 10 to column 11)",
  " (in 'string', line 87, column 20 to column 21)",
  " (in 'string', line 87, column 23 to column 24)",
  " (in 'string', line 87, column 4 to column 32)",
  " (in 'string', line 89, column 0 to column 17)",
  " (in 'string', line 93, column 4 to column 34)",
  " (in 'string', line 92, column 17 to line 94, column 3)",
  " (in 'string', line 92, column 2 to line 94, column 3)",
  " (in 'string', line 91, column 15 to line 95, column 1)",
  " (in 'string', line 91, column 0 to line 95, column 1)",
  " (in 'string', line 96, column 11 to column 12)",
  " (in 'string', line 96, column 4 to column 39)",
  " (in 'string', line 101, column 2 to column 54)",
  " (in 'string', line 100, column 14 to line 102, column 1)",
  " (in 'string', line 100, column 0 to line 102, column 1)",
  ...
  " (in 'string', line 98, column 20 to line 109, column 7)",
  " (in 'string', line 98, column 6 to line 109, column 7)",
  " (in 'string', line 110, column 6 to column 44)",
  " (in 'string', line 97, column 18 to line 111, column 5)",
  " (in 'string', line 97, column 4 to line 111, column 5)",
  ...
  " (in 'string', line 46, column 19 to column 22)",
  " (in 'string', line 46, column 0 to column 28)",
  " (in 'string', line 51, column 8 to column 9)",
  " (in 'string', line 54, column 6 to column 7)",
  " (in 'string', line 54, column 16 to column 21)",
  ...
  " (in 'string', line 63, column 16 to column 17)",
  " (in 'string', line 63, column 19 to column 22)",
...
public:
  ...
  model_multichannel_nhmm_cvc(stan::io::var_context& context__, unsigned int
    ...
    num_params_r__ = (S - 1) + (S * beta_s_raw_2dim__ * K_s) + (C * S * (M -
      1));
  }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"Pi", "beta_s_raw", "B"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"log_lik_", "prior_", "beta_s"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"Pi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(S) + "},\"block\":\"parameters\"},{\"name\":\"beta_s_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_s_raw_2dim__) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"parameters\"},{\"name\":\"B\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(C) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(M) + "}}},\"block\":\"parameters\"},{\"name\":\"log_lik_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"prior_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"beta_s\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(S) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"prior\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"Pi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((S -1)) + "},\"block\":\"parameters\"},{\"name\":\"beta_s_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_s_raw_2dim__) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"parameters\"},{\"name\":\"B\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(C) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((M -1)) + "}}},\"block\":\"parameters\"},{\"name\":\"log_lik_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"prior_\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"beta_s\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(S) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(S) + ",\"cols\":" + std::to_string(K_s) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"prior\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((S + ((S * beta_s_raw_2dim__) * K_s)) + ((C
      * S) * M));
