...
<<plotd, fig.width=5, fig.height=3, dev.args=list(pointsize=10), fig.keep='last', fig.align='center', cache=TRUE, fig.cap = "State distribution plots for multichannel data drawn with the \\texttt{ssplot} function.">>=
ssplot(
