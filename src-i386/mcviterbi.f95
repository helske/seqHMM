subroutine mcviterbi(a,b,init,obs,m,p,n,miss,q,r)
...
subroutine mvmcviterbi(a,b,init,obs,m,p,n,miss,k,q,r)
    ...
    integer i
    do i=1,k
        call mcviterbi(a,b,init,obs(i,:,:),m,p,n,miss(i,:,:),q(i,:),r)
    end do
