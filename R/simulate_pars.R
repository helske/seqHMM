...
#' 
#' These are helper functions for quick construction of initial values for various model building functions.
#' 
#' @export
#' @param n_states Number of states in each cluster.
#' @param n_clusters Number of clusters.
#' @param left_right Constrain the transition probabilities to upper triangular. Default is \code{FALSE}.
