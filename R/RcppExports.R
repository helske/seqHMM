...
log_EM <- function(transitionMatrix, emissionArray, initialProbs, obsArray, nSymbols, itermax = 100L, tol = 1e-8, trace = 0L, threads = 1L) {
...
log_EMx <- function(transitionMatrix, emissionArray, initialProbs, obsArray, nSymbols, coefs, X_, numberOfStates, itermax = 100L, tol = 1e-8, trace = 0L, threads = 1L) {
...
log_forwardbackward <- function(transitionMatrix, emissionArray, initialProbs, obsArray, forwardonly, threads = 1L) {
    .Call('seqHMM_log_forwardbackward', PACKAGE = 'seqHMM', transitionMatrix, emissionArray, initialProbs, obsArray, forwardonly, threads)
}

log_forwardbackwardx <- function(transitionMatrix, emissionArray, initialProbs, obsArray, coefs, X_, numberOfStates, forwardonly, threads = 1L) {
...
log_logLikHMM <- function(transitionMatrix, emissionArray, initialProbs, obsArray, threads = 1L) {
    .Call('seqHMM_log_logLikHMM', PACKAGE = 'seqHMM', transitionMatrix, emissionArray, initialProbs, obsArray, threads)
}

log_logLikMixHMM <- function(transitionMatrix, emissionArray, initialProbs, obsArray, coefs, X_, numberOfStates, threads = 1L) {
...
log_objective <- function(transitionMatrix, emissionArray, initialProbs, obsArray, transNZ, emissNZ, initNZ, nSymbols, threads = 1L) {
...
log_objectivex2 <- function(transitionMatrix, emissionArray, initialProbs, obsArray, transNZ, emissNZ, initNZ, nSymbols, coefs, X_, numberOfStates, threads = 1L) {
    .Call('seqHMM_log_objectivex2', PACKAGE = 'seqHMM', transitionMatrix, emissionArray, initialProbs, obsArray, transNZ, emissNZ, initNZ, nSymbols, coefs, X_, numberOfStates, threads)
}

log_objectivex <- function(transitionMatrix, emissionArray, initialProbs, obsArray, transNZ, emissNZ, initNZ, nSymbols, coefs, X_, numberOfStates, threads = 1L) {
