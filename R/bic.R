...
#'   \code{\link{trimHMM}} for details. The default is \code{FALSE}.
...
#'   \code{\link{fitMixHMM}} for building and fitting mixture hidden Markov 
#'   models, and \code{\link{trimHMM}} for finding better models by changing 
