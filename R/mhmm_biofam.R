...
#' Cluster 1
#' B1_marr <- matrix(
#'   c(0.4, 0.4, 0.1, # High probability for single
#'     0.4, 0.4, 0.1,
#'     0.4, 0.4, 0.1, # High probability for married
#'     0.4, 0.4, 0.1), # High probability for divorced
#'   nrow = 4, ncol = 3, byrow = TRUE)
#' 
#' B1_child <- matrix(
#'   c(0.5, 0.5, # High probability for childless
#'     0.5, 0.5,
#'     0.5, 0.5,
#'     0.5, 0.5),
...
#' 
#' B1_left <- matrix(
#'   c(0.5, 0.5, # High probability for living with parents
#'     0.5, 0.5, # High probability for having left home
#'     0.5, 0.5,
#'     0.5, 0.5),
#'   nrow = 4, ncol = 2, byrow = TRUE)
#' 
...
#'     0.6, 0.2, 0.2,
#'     0.4, 0.4, 0.2, # High probability for married
#'     0.4, 0.4, 0.2),
#'   nrow = 4, ncol = 3, byrow = TRUE)
#' 
#' B2_child <- matrix(
...
#'     0.8, 0.1, 0.1,
#'     0.8, 0.1, 0.1,
#'     0.3, 0.4, 0.3, # High probability for married
#'     0.3, 0.4, 0.3,
...
#' A4 <- matrix(0, 4, 4)
#' A4[upper.tri(A4)] <- 0.05
#' diag(A4) <- 1 - rowSums(A4)
#' 
#' A6 <- matrix(0, 6, 6)
#' A6[upper.tri(A6)] <- 0.05
#' diag(A6) <- 1 - rowSums(A6)
#' 
#' # Starting values for initial state probabilities
#' initial_probs1 <- c(0.97, 0.01, 0.01, 0.01)
#' initial_probs2 <- c(0.95, 0.01, 0.01, 0.01, 0.01, 0.01)
#' 
#' # Birth cohort
...
#'   transition_probs = list(A4, A4, A6),
